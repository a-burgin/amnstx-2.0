...
export default function Footer(){
 return <footer className="footer"><div className="container footer-grid">
  <div><h2>A Mobile Notary Service</h2><p>AMNS TX provides mobile notary services across Dallas-Fort Worth and remote online notarization for eligible Texas documents statewide.</p></div>
