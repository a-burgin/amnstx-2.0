...
export default function Header() {
  const links = [
    ["Home","/"],["Services","/services"],["Pricing","/pricing"],["Online","/online-notary"],["Mobile","/mobile-notary"],
    ["Accepted IDs","/accepted-ids"],["FAQ","/faq"],["Add-Ons","/add-on-services"],["Areas","/service-areas"],["Terms","/terms"]
  ];
  return <>
    ...
    <header className="header"><div className="container nav">
      ...
      <div className="header-actions"><a className="btn btn-secondary" href="tel:+12144715358">Call 214-471-5358</a><a className="btn btn-primary" href={bookingLink}>Book Appointment</a></div>
    </div></header>
  </>
}
